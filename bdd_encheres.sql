...
-- Transformation no_article en no_retrait avec ajout IDENTITY
...
-- L'adresse pourrait être optimisée avec un no regroupant rue, code_postal et ville
...
-- Ajout du no_retrait avec foreign key
...
ALTER TABLE ARTICLES_VENDUS
    ADD CONSTRAINT no_retrait_fk FOREIGN KEY ( no_retrait ) REFERENCES RETRAITS ( no_retrait )
ON DELETE NO ACTION 
    ON UPDATE no action 
